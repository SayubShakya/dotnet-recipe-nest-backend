...
namespace RecipeNest.Request
{
    ...
    public class CreateRecipeRequest
    {
        ...
        public CreateRecipeRequest(string title, string recipeDetail, string ingredients, string? imageUrl = null, string? description = null, int? recipeByUserId = null, int? cuisineId = null)
        {
            ImageUrl = imageUrl;
            Title = title;
